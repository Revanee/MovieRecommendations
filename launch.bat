...
set MAIN_JAR=C:\Users\Utente\Desktop\MovieRecommendations\target\scala-2.10\movierecommendations_2.10-0.1.jar
set DEPENDENCY_JARS=C:\Users\Utente\Desktop\MovieRecommendations\dependencies\spark-csv_2.10-1.4.0.jar
